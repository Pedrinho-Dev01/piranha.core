...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piranha.Data.Page", b =>
                {
                    ...
                    b.Property<int?>("WorkflowStatusValue")
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Piranha.Data.Workflow", b =>
                {
                    ...
                    b.ToTable("Piranha_Workflows", (string)null);
                });
            ...
            modelBuilder.Entity("Piranha.Data.Page", b =>
                {
                    ...
                    b.HasOne("Piranha.Data.Workflow", "Workflow")
                        .WithOne()
                        .HasForeignKey("Piranha.Data.Page", "WorkflowId");
            ...
            modelBuilder.Entity("Piranha.Data.WorkflowStep", b =>
                {
                    b.HasOne("Piranha.Data.Workflow", null)
                        .WithMany("Steps")
